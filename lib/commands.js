module.exports={
    ...
    getText: async function(page, selector) {
        try {
            ...
            throw new Error(`Text is not available for selectore: ${selector}`);
        }
    },
    ...
    expectedTicketInfo: async function(page, movie, sessionStart) {
        const selectorMovie = await page.$eval(".ticket__title", (link) => link.textContent);
        const selectorTime = await page.$eval(".ticket__start", (link) => link.textContent);
